...
export default function WhyChooseMe() {
  return (
    <section className="py-4 sm:py-4 lg:py-18 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-5 sm:mb-5 lg:mb-16">
        ...
        {/* CTA Banner */}
        <div className="mt-3 sm:mt-3 lg:mt-14 relative overflow-hidden rounded-2xl border border-primary-500/20 p-2 sm:p-2 md:p-14">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <h3 className="font-heading font-900 text-xl sm:text-xl md:text-4xl text-white mb-3">
                Ready to Go <span className="text-gradient">Live?</span>
              </h3>
              <p className="text-slate-400 max-w-md text-sm sm:text-sm lg:text-lg">Join 50+ businesses that trust us to build their digital presence — on time and on budget.</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
              <button onClick={() => document.getElementById('contact')?.scrollIntoView({behavior:'smooth'})}
                className="btn-primary">
                <span className='text-sm sm:text-sm lg:text-lg'>Start Project</span>
              ...
              <a href="https://wa.me/919661911152" target="_blank" rel="noopener noreferrer" className="btn-orange">
                ...
                <span className='text-sm sm:text-sm lg:text-lg'>WhatsApp Now</span>
              </a>
            </div>
          </div>
        </div>
