const CTA_IMG = '/images/office.webp';
    ...
    <section className="py-10 md:py-18 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden min-h-[420px] flex items-center">
          {/* Background image */}
          <img src={CTA_IMG} alt="Team working" className="absolute inset-0 w-full h-full object-cover " loading="lazy" />
          <div className="absolute inset-0 bg-gradient-to-t from-navy-900/70 via-navy-900/70 to-navy-900/70"></div>
          {/* Dark overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-navy-900/97 via-navy-900/90 to-navy-900/70" />
          {/* Blue overlay */}
          ...
          <div className="relative z-10 p-3 sm:p-3 md:p-16 max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <a href="https://wa.me/919661911152?text=Hi!%20I'd%20like%20to%20discuss%20a%20website%20project."
                target="_blank" rel="noopener noreferrer" className="btn-orange text-[15px]">
